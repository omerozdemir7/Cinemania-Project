import{f as c,a as d,b as h}from"./api-DdP_p3xO.js";import{Modal as i}from"./modal-BzXhaMjf.js";import"https://cdn.jsdelivr.net/npm/basiclightbox@5.0.4/+esm";const u="https://image.tmdb.org/t/p/original";async function n(){var r;const t=document.getElementById("hero");if(t)try{const e=await c(),s=Array.isArray((r=e==null?void 0:e.data)==null?void 0:r.results)?e.data.results:(e==null?void 0:e.results)||[];if(!s.length){l(t);return}const o=s[Math.floor(Math.random()*s.length)];g(t,o)}catch(e){console.error("Movie init error:",e),l(t)}}function _(t){const r=Math.floor(t/2),e=t%2>=1,s=5-r-(e?1:0);let o=[];for(let a=0;a<r;a++)o.push('<svg class="hero__icon--full-star"><use xlink:href="/Cinemania-Project/images/icon.svg#icon-full-star"></use></svg>');e&&o.push('<svg class="hero__icon--half-star"><use xlink:href="/Cinemania-Project/images/icon.svg#icon-half-star"></use></svg>');for(let a=0;a<s;a++)o.push('<svg class="hero__icon--empty-star"><use xlink:href="/Cinemania-Project/images/icon.svg#icon-empty-star"></use></svg>');return o.join("")}function g(t,r){const e=_(r.vote_average);t.innerHTML=`
...
//# sourceMappingURL=hero-BTaay8LO.js.map
