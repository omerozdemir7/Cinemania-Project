import{c as b}from"./api-C-8Ffavt.js";import{Modal as v}from"./modal-BzXhaMjf.js";import"https://cdn.jsdelivr.net/npm/basiclightbox@5.0.4/+esm";const y=document.getElementById("library-list"),g=document.getElementById("empty-library"),s=document.getElementById("genre-filter"),a=document.getElementById("load-more-btn");let c={},d=[],l=0;const _=9;function E(r){const e=(Number(r)||0)/2;let t="";for(let i=1;i<=5;i++)e>=i?t+=`
...
//# sourceMappingURL=library-BWGgaJON.js.map
