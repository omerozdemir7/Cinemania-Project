import{d as k,e as w,f as v}from"./api-Dh70rJD-.js";import{Modal as S}from"./modal-BzXhaMjf.js";import"https://cdn.jsdelivr.net/npm/basiclightbox@5.0.4/+esm";let i,c,u=[],d=!1;function g(){const t=window.innerWidth;return t<768?1:(t<1280,3)}function M(t){const r=Math.floor(t/2),n=t%2>=1,s=5-r-(n?1:0);let l=[];for(let a=0;a<r;a++)l.push('<svg class="weekly__icon--full-star"><use xlink:href="/images/icon.svg#icon-full-star"></use></svg>');n&&l.push('<svg class="weekly__icon--half-star"><use xlink:href="/images/icon.svg#icon-half-star"></use></svg>');for(let a=0;a<s;a++)l.push('<svg class="weekly__icon--empty-star"><use xlink:href="/images/icon.svg#icon-empty-star"></use></svg>');return l.join("")}async function p(t=g()){try{const[r,n]=await Promise.all([w(),v()]);u=r.results;const s=n.genres.reduce((e,o)=>(e[o.id]=o.name,e),{}),a=u.slice(0,t).map(e=>{const o=e.poster_path?`https://image.tmdb.org/t/p/w500${e.poster_path}`:"https://via.placeholder.com/500x750?text=No+Image",f=e.genre_ids.map(m=>s[m]).slice(0,1).join(", "),_=e.release_date?e.release_date.slice(0,4):"N/A",h=M(e.vote_average);return`
